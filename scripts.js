...
(function () {
    ...
    function bindContact() {
        ...
        if (dEl) {
            ...
            if (C.ids && C.ids.scholar) {
                rows.push(`
                <p class="contact-direct-row">
                    <span class="contact-direct-icon">${ICONS.scholar}</span>
                    <a class="contact-direct-link" href="https://scholar.google.com/citations?user=${C.ids.scholar}&hl=en" target="_blank" rel="noopener">Google Scholar profile</a>
                </p>`);
            }
            if (C.ids && C.ids.orcid) {
                rows.push(`
                <p class="contact-direct-row">
                    <span class="contact-direct-icon">${ICONS.orcid}</span>
                    <a class="contact-direct-link" href="https://orcid.org/${C.ids.orcid}" target="_blank" rel="noopener">ORCID ${C.ids.orcid}</a>
                </p>`);
            }
