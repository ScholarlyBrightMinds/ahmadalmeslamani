...
def render_summary_card(
    ...
    brand_url = f"scholarlybrightminds.github.io/{repo_name}" if repo_name else "scholarlybrightminds.github.io"
    draw.text(
        (pad, CARD_H - 44),
        brand_url,
        font=f_brand,
...
def main() -> int:
    ...
    summary = render_summary_card(full_name, total, cites, hidx, top_papers, repo_name=repo_name)
